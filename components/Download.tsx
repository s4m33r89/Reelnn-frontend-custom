...
interface DownloadProps {
  ...
  fileId?: string; // Support for direct bundle file ID
  isBundle?: boolean; // Flag for bundle type
}
...
const Download: React.FC<DownloadProps> = ({ 
  ...
  // Pass fileId to the hook. Assuming the hook will use it if present.
    ...
    try {
      ...
      const response = await fetch('/api/download', {
        ...
        body: JSON.stringify({
          ...
          seasonNumber,
          episodeNumber,
          fileId, // Include fileId in download API call
          isBundle // Include bundle flag
        }),
      });
...
}, [isOpen, streamUrl, title, selectedQuality, contentId, episodeNumber, qualityIndex, seasonNumber, fileId, isBundle]);
