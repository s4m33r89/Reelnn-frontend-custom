...
interface UseStreamTokenParams {
  ...
  fileId?: string; // Added fileId support
  isBundle?: boolean; // Added bundle flag
  isActive: boolean;
}
...
export function useStreamToken({
  ...
  }, [contentId, mediaType, qualityIndex, seasonNumber, episodeNumber, fileId, isBundle, isActive]);
